                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text('IQJ MIREA версия 0.0.1\nсборка 221803-24042024\nИПТИП/КИП (с) 2024 - Все права защищены.'),
                      const Padding(padding: EdgeInsets.only(bottom: 512)),
                      Text('Без обид, API нужно доработать, мне надоело работать с неработающими запросами. Кто делал запросы для новостей может поесть грибов от вадимовой новой аптеки.\n\n\nЭто шутка))) но в каждой шутке есть доля правды, помните!'),
                    ],
                  ),
                ],
              ),
